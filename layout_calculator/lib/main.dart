...
class _MyHomePageState extends State<MyHomePage> {
  // LCD에 출력할 문자열과 계산을 위한 문자열 
   String _displayText = "0", _tempText = "0"; //계산기 화면에 쓸 변수부터 설정 /앞에 초기값은 0 출력할 문자와 계산하기 위한 0
   // 연산자
   String _operText = "";
              ...
              Expanded(
                flex: 1,
                 child: AspectRatio(     // 자식 위젯을 특정한 비율로 만드는 클래스
                  aspectRatio: 1/1, // 가로세로 비율 
                   child: Container(
                    padding: const EdgeInsets.fromLTRB(2, 2, 2, 2), //중앙이기 때문에 2번째 부터 앞이 4가아닌 2
                     child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.grey[400],
                      ),
               ...
               Expanded(
                flex: 1,
                 child: AspectRatio(     // 자식 위젯을 특정한 비율로 만드는 클래스
                  aspectRatio: 1/1, // 가로세로 비율 
                   child: Container(
                    padding: const EdgeInsets.fromLTRB(2, 2, 4, 2), // 맨앞이 4 끝에 맞춰줘서 4
                     child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.orange[400], // 맨마지막 색상을 다르게 바꿔줌
                      ),
                       child: const Text(
                          "/",
                          style: TextStyle(
                  ...
                  aspectRatio: 1/1, // 가로세로 비율 
                   child: Container(
                    padding: const EdgeInsets.fromLTRB(2, 2, 4, 2), // 맨앞이 4 끝에 맞춰줘서 4
                     ...
                     onPressed: () {
                       _calculate(); // 입력이 아닌 결과값을 불러와야하기 때문에 _calculate를 넣어 =의 값을 만들어줌.
                     },
                             ),
                   ),
                 ),
