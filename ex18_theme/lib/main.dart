...
class MyApp extends StatelessWidget { // 여기서 테마 선언
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.orange), // 맨 위 타이틀 배경 색상
        useMaterial3: true,
        // 선택되지 않은 라디오 버튼 색깔
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                child: const Text('디폴트 테마 - 버튼0', style: 
              ...
              Checkbox(
                ...
                activeColor: Colors.greenAccent,  // 체크되었을때 배경색
